# Contributing to exuber

This outlines how to propose a change to exuber. For more detailed info
...
Please note that the exuber project is released with a [Contributor Code
of Conduct](https://kvasilopoulos.github.io/exuber/CODE_OF_CONDUCT.md).
