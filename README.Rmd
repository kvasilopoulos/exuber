...
For generating critical values we have several options. Firstly, the package offers simulated critical values (up to 700 observations) in the form of `data`  that are obtain with the `mc_cv()` function.
