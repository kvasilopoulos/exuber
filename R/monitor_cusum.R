...
# (monitor(..., boundary = "fluc")) -- both now implemented.
#
...
# lookup-and-snap pattern as monitor.R's hb_fluc_q()/hb_fluc_table
...
# data is used at each t, unlike monitor()'s training-only wild
