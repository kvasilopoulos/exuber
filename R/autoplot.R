...
#'
#' @param include_rejected If not FALSE, plot all variables regardless of rejecting the NULL at the 5\% significance level.
...
#' @param shade_color the shade color that indicates the exuberance periods. Defaults
#' to grey70.
