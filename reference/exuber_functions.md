...
#>   name           family   description                                           
#>   <chr>          <chr>    <chr>                                                 
#> 1 lbi_test       test     Locally best invariant test for a bubble spanning the…
#> 2 ssu_test       test     Stochastic explosive-coefficient test on squared firs…
#> 3 quantile_test  test     Quantile-regression global test, an alternative to th…
#> 4 cobubble_test  test     KPSS-type co-explosive test between two series (Evrip…
#> 5 radf_sbz_union adf,test SBZ union-of-rejections test (supDF and supBZ, paired…
```
