...
dstamp_stocks
```
We can extract the datestamp as a dummy variable 1 = Exuberance, 0 = No exuberance. Recent studies Pavlidis et al (2018) & Pavlidis and Vasilopoulos (2020) use the datestamp in a probit model, thus ...
