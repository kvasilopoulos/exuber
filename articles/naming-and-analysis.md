...
| `root_` prefix | Confidence-interval inference on the *magnitude* of the explosive root, not a test for its presence | [`explosive_root()`](https://kvasilopoulos.github.io/exuber/reference/explosive_root.md), [`root_ci()`](https://kvasilopoulos.github.io/exuber/reference/root_ci.md), [`root_ci_datestamp()`](https://kvasilopoulos.github.io/exuber/reference/root_ci_datestamp.md) |
